...
`;const m=f.querySelector("iframe");if(!m)throw new Error("missing generated frame");const y=x({frameId:"frame-001",sessionId:"session-001",capabilityId:"cap-001",artifactId:"artifact-001",artifactRevision:"artifact.rev.7",schemaRevision:"schema.rev.1",commands:["select_artifact"],sessions:[],chain:{chainId:"chain-001",rootId:"root-001",hop:0,maxHops:5}});window.addEventListener("message",e=>{if(e.source!==m.contentWindow)return;s.ready={origin:e.origin,source:!0},l();const n=e.data;if(n?.type==="content.ready"){m.contentWindow?.postMessage({type:"tinkabot.lease",lease:y},"*");return}if(n?.type==="content.probe"){s.probe={cookie:n.cookie,storage:n.storage},l();return}try{const o=S(y,e.source,m.contentWindow,n);s.accepted.push(o)}catch(o){s.denied.push(o instanceof Error?o.message:String(o))}l()});m.src=L();l();function l(){f.querySelector('[data-proof="sandbox"]').textContent=s.sandbox,f.querySelector('[data-proof="accepted"]').textContent=String(s.accepted.length),f.querySelector('[data-proof="denied"]').textContent=String(s.denied.length),f.querySelector('[data-proof="cookie"]').textContent=s.probe?.cookie||"empty"}
