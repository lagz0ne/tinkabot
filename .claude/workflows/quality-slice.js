export const meta = {
  name: 'quality-slice',
  description: 'Drive one platform slice through RED-GREEN-TDD with real-NATS, parallel-test, dual-coverage, be-lazy, no-slop, and security gates',
  whenToUse: 'Run per milestone with args {topic: "<slice>"} (e.g. release-spine). args {dryRun: true} stops after the slice contract for a cheap mechanics check.',
  phases: [
